...
LH = max(longest_run_tracker(1:Num));
fprintf('The Length of the longest run of Heads (LH)is %d\n',LH); %Printing the maximum value that the variable 'j' has taken throughout the whole experiment. This is the required count for the longest run of heads.
